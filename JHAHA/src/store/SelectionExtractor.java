        ...
        selectWisdom.setOnAction(event -> {
            ...
            if (webView != null) {
                ...
                if (selection instanceof String) {
                    ...
                    add = "<font color='red'>"+add+"</font>";
                    String ppp = wisdom.getHtmlText().toString().replace((String) selection,add);
                    System.out.println(wisdom.getHtmlText().toString().indexOf((String) selection));
                    wisdom.setHtmlText(ppp);
                }
            }
        });
